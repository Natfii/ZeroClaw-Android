...
class PluginDaoTest {
    ...
    @Test
    fun upsert_and_observeAll_returns_plugins() = runBlocking {
    ...
    @Test
    fun setInstalled_marks_plugin_as_installed() = runBlocking {
    ...
    @Test
    fun uninstall_clears_installed_and_enabled() = runBlocking {
    ...
    @Test
    fun toggleEnabled_only_affects_installed_plugins() = runBlocking {
    ...
    @Test
    fun toggleEnabled_flips_state_for_installed_plugin() = runBlocking {
    ...
    @Test
    fun updateConfigJson_updates_config() = runBlocking {
        dao.upsert(makePlugin("p1", "Plugin A"))
    ...
    @Test
    fun insertAllIgnoreConflicts_does_not_overwrite_existing() = runBlocking {
