...
class LogEntryDaoTest {
    ...
    @Test
    fun insert_and_observeRecent_returns_entries_newest_first() = runBlocking {
    ...
    @Test
    fun observeRecent_respects_limit() = runBlocking {
        repeat(5) { i ->
    ...
    @Test
    fun deleteAll_clears_all_entries() = runBlocking {
    ...
    @Test
    fun pruneOldest_retains_most_recent() = runBlocking {
    ...
    @Test
    fun count_returns_correct_value() = runBlocking {
